            ...
            render: (text, record) => (
                <span>
                    <Button type="primary" size="small">
                        <Link to={`/app/project/${projectResourceId}/setting/${record.settingId}/git-provider/edit?mode=VIEW`}>
                            View
                        </Link>
                    </Button>
                    <Divider type="vertical" />
                    <Button type="primary" size="small">
                        <Link to={`/app/project/${projectResourceId}/setting/${record.settingId}/git-provider/edit?mode=EDIT`}>
                            Edit
                        </Link>
                    </Button>
                    <Divider type="vertical" />
            ...
            <Row type="flex" justify="start" align="middle" style={{ paddingTop: '10px', paddingBottom: '5px' }}>
                ...
                <Col span={11} offset={-1}>
                    <Row type="flex" justify="end" align="middle">
                        <Button type="primary"  >
                            <Link to={`/app/project/${projectResourceId}/setting/git-provider/add`}>Add</Link>
                        </Button>
                    </Row>
                </Col>
            </Row>
