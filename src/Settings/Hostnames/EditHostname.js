    ...
    function updateSetting(e) {
        ...
        validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                axios.put(`${process.env.REACT_APP_API_BASE_URL}/v1/settings/hostname-ip-mapping/${projectResourceId}/${settingId}`, data)
                    .then((response) => {
                        setIconLoading(false);
                        message.success('Hostname updated successfully.', 5);
    ...
    return (
        <div style={{ minHeight: 'calc(100vh - 64px)' }}>
            <Row type="flex" justify="center" align="middle" style={{ paddingTop: '2px', paddingBottom: '4px' }}>
                <Col span={24}>
                    <label style={{ fontWeight: 'bold', fontSize: 18 }} >Edit Hostname</label>
                    <span>&nbsp;&nbsp;</span>
...
const WrappedComponent = Form.create({ name: 'edit-hostname' })(EditHostname);
